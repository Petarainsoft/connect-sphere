...
#pragma warning disable 0649
        ...
        [SerializeField] internal SignalingSettingsObject signalingSettingsObject;
...
#pragma warning restore 0649
        ...
        private Dictionary<string, SignalingHandlerBase> currentHandlers =
            new Dictionary<string, SignalingHandlerBase>();

        public void AddHandler(SignalingHandlerBase signalingHandler)
        {
            signalingHandler.SetHandler(m_instance);
            m_provider.Subscribe(signalingHandler);
        }

        public void RemoveHandler(SignalingHandlerBase signalingHandler)
        {
            signalingHandler.SetHandler(null);
            m_provider.Unsubscribe(signalingHandler);
        }

        public void Configure(
            RTCConfiguration? conf = null,
            ISignaling signaling = null,
            SignalingHandlerBase[] handlers1 = null
        )
        {
